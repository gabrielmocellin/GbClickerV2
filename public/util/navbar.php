<div id="div-menu-navbar" class="menuClosed">
    <ul class="navbar">
        <li onclick="gerenciadorNavbar.RedirectPage(1)">
        ...
        ?>
        <li onclick="gerenciadorNavbar.RedirectPage(101)">
        ...
        ?>
        <li onclick="gerenciadorNavbar.RedirectPage(2)">
            <img draggable="false" src="<?= $GLOBALS['prefix'] ?>img/icons/shopping_cart.png" alt="Loja">
            Loja
        </li>
        <li onclick="gerenciadorNavbar.RedirectPage(4)">
