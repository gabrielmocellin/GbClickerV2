<div id="div-menu-navbar" class="menuClosed">
    <ul class="navbar">
        ...
        <li>
            <img draggable="false" src="img/icons/account.png" alt="Perfil">
            Perfil
        </li>
        ...
        <li>
            <img draggable="false" src="img/icons/settings.png" alt="Configurações">
            Configurações
        </li>
        <li onclick="RedirectPage('2')">
            <img draggable="false" src="img/icons/ticket.png" alt="Admin Criar Itens">
            Itens | ADMIN
        </li>
        <li>
        ...
        <li onclick="RedirectPage('4')">
            <img draggable="false" src="img/icons/maintenance.png" alt="Deslogar">
            Sair | Logout
        </li>
    </ul>
</div>